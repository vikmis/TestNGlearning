...
public class Testcase2 {
	...
	public void validateTitles() {
		...
		softAssert.assertEquals(actual_title, expected_title);//-----fail
		//isElementPresent("xpath") - True, False
		//Assert.assertTrue(false,"Element not found");
		System.out.println("Validating image");
		softAssert.assertEquals(true, false,"image not present"); //---- fail
		
		System.out.println("validate text box presence");
		softAssert.assertEquals(true, false,"text box not present"); //-- fail
